...
Motion::Project::App.setup do |app|
  ...
  app.name = 'LivingMindfully'
  app.identifier = 'uk.co.arcane-industries.livingmindfully'

  app.short_version = '0.1.18'
  ...
  app.development do
    app.codesign_certificate = "iPhone Developer: MYNAME"
    app.provisioning_profile = "path/to/development.mobileprovision"
  end

  app.release do
    app.entitlements['get-task-allow'] = false
    app.codesign_certificate = 'iPhone Distribution: Jay Snee (MYSEED)'
    app.provisioning_profile = '/path/to/LivingMindfullyTestflight.mobileprovision'
